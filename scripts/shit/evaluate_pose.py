...
def evaluate(opt):
    ...
    dataloader = DataLoader(dataset, opt.eval_odom_batch_size, shuffle=False,
    ...
    gt_poses_path = os.path.join(opt.eval_pose_data_path, "poses", "{:02d}.txt".format(sequence_id))
